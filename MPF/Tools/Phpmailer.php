...
class Phpmailer
{
    ...
    */
    ...
    function CreateHeader() {
        ...
        $result .= $this->HeaderLine("X-Mailer", "QiumiMail [version " . $this->Version . "]");
    ...
    function Received() {
        ...
        $result = sprintf("Received: from %s %s\tby %s " .
                          "with %s (QiuMiMail);%s\t%s%s", $remote, $this->LE,
