...
/*
	...
	LICENCE     : GPL
	REVISION    : V1.0.2
	MIME类型		：ZIP的MIME类型用application/x-zip-compressed,RAR的MIME类型用application/octet-stream
*/
class Upfile{
	var $saveName;// 保存名
	var $savePath;// 保存路径
			...
			if (($originalHeight < $this->thumbHeight
				...
				*/
				...
				if ( !$SaveFunction($createdThumb,
					$this->savePath.'thumb/'.$this->thumbPrefix.$this->saveName) )
